...
contract('QCoinBasic', function(accounts) {
    ...
    it("check initialized balance", function() {
        ...
        return QCoinBasic.deployed().then(function(instance) {
            qcoin = instance;
            return qcoin.getBalance.call(accounts[0]);
        }).then(function(result) {
            //console.log(result);
            assert.equal(result.valueOf(), 100, "QCoinBasic initialized with value NOT equal to 100!!!");
        });
    });
